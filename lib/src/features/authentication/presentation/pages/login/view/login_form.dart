// lib/src/features/authentication/presentation/pages/login/view/login_form.dart
import 'package:bandasybandas/src/app/localization/app_localizations.dart';
import 'package:bandasybandas/src/core/theme/app_spacing.dart';
import 'package:bandasybandas/src/features/authentication/presentation/pages/login/cubit/login_cubit.dart';
import 'package:bandasybandas/src/features/authentication/presentation/pages/login/cubit/login_state.dart';
      ...
      listener: (context, state) {
        if (state.status.isFailure) {
          ScaffoldMessenger.of(context)
            ...
            ..showSnackBar(
              SnackBar(
                content: Text(state.errorMessage ?? l10n.error_unexpected),
              ),
            );
        }
      },
